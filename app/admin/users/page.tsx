        ...
        <Table className="admin-table border border-gray-300 rounded-lg overflow-hidden shadow-lg">
          <TableHeader>
            <TableRow className="bg-gray-100 border-b-2 border-gray-300">
              ...
              <TableHead className='text-left bg-gray-100 text-gray-800 font-semibold py-4 px-4'>Phone Number</TableHead>
              <TableHead className='text-left bg-gray-100 text-gray-800 font-semibold py-4 px-4'>Role</TableHead>
              <TableHead className='text-left bg-gray-100 text-gray-800 font-semibold py-4 px-4'>Registration Date</TableHead>
